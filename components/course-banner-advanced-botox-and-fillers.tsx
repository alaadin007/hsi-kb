...
export function CourseBanner() {
  return (
    <section className="relative min-h-[600px] lg:h-[600px] bg-[url('https://www.theharleystreet.com/wp-content/uploads/2021/04/advance-botox_banner.jpg')] bg-cover bg-center">
      ...
      <div className="relative container mx-auto px-4 py-32 lg:pt-32">
        <div className="grid lg:grid-cols-2 gap-8 items-start lg:items-center">
          <div className="space-y-6">
            ...
            Advanced Botox & Dermal Fillers Training
            </h1>
            <p className="text-lg lg:text-xl text-gray-200">
            Learn advanced Botox & Dermal Fillers treatment skills
            </p>
          ...
          <Card className="p-6 bg-gray-900/90 border-silver-600/20 mt-8 lg:mt-0">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-silver-200">Intermediate</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-silver-200">8</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
            ...
            <div className="mt-6 pt-6 border-t border-silver-600/20">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <p className="text-xl font-semibold text-silver-200">Online Modules: £125</p>
                <p className="text-xl font-semibold text-silver-200">Practical: £1190 + VAT</p>
                <a href='https://med.as.me/hsi-short-courses' target='blank'>
